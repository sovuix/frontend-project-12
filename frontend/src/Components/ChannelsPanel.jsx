...
const ChannelsPanel = ({ channels = [] }) => {
  ...
  const [
    createChannel,
    { data: createData, error: createChannelError, reset: resetCreateChannel },
  ] = useCreateChannelMutation()

  const [
    deleteChannel,
    { data: deleteData, error: deleteChannelError, reset: resetDeleteChannel },
  ] = useDeleteChannelMutation()

  const [
    renameChannel,
    { data: renameData, error: renameChannelError, reset: resetRenameChannel },
  ] = useRenameChannelMutation()
  ...
  }, [currentData, currentError, modalType, t])
